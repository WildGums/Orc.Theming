...
public class ThemeImage : Control
{
    ...
    public static readonly DependencyProperty SourceProperty = DependencyProperty.Register(nameof(Source),
        typeof(string), typeof(ThemeImage), new PropertyMetadata(null, (sender, _) => ((ThemeImage)sender).OnSourceChanged()));
    ...
    private void UpdateSource()
    {
        ...
        {
            var ready = false;
            var baseColorScheme = _baseColorSchemeService.GetBaseColorScheme().ToLower();
